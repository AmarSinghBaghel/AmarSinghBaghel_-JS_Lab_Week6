 ...
 * 
 * Methods
 * getCurrentQuestion = return the question objcet for questionIndex
 * checkOptionWithAnswer = answer is checked against correct answerof current question
...
function loadQuestion() {
    ...
    //get the DOM Nodes for the question and set the question in it
    const questionEl = document.getElementById('question');
    questionEl.textContent = quiz.getCurrentQuestion().text;

    //loop through choices for the question get the choice element in UI
...
function handleSelect(id, choice) {
    ...
    //onclick will replace yhe old event handler
    //for the button and set up the new handlers get set
    //up since we add a handler in each step of quiz.
